...
layout(location=2)  uniform mat4 u_TransformMatrix;
...
//	v_position = u_TransformMatrix.xyz;
	gl_Position =  u_ProjectionMatrix * u_ViewMatrix * u_TransformMatrix *vec4(a_Position,1.0);
